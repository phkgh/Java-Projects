...
public class MonthSort {															//sorting the data by month
  ...
  private void sortAscending() {													//sorting the data in the ascending order
      ...
      displayOutput("Hurricane Months in Ascending Order");
  ...
  private void sortDescending() {													//sorting the data in the descending order
      ...
      displayOutput("Hurricane Months in Descending Order");
  }
  ...
  private void writeOutput(JTable table) {													//creating an output file and writing the results to it
      try {
          PrintWriter p = new PrintWriter(new File("SortByMonthPappu.txt"));
